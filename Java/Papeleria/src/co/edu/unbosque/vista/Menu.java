 ...
 * Botones, Campos de texto, Paneles, y dem�s.
 * Permite que la interacci�n del usuario con el programa sea m�s din�mica y pr�ctica.
 * @author fedeS
 *
 */
...
public class Menu extends JFrame  {
	...
	public Menu() {
		...
		setTitle("Papeleria 'La Cartulina'");
		setSize(800, 460);
		...
		agregar.setFont(new Font("Bahnschrift", Font.ITALIC, 15));
		...
		listar.setFont(new Font("Bahnschrift", Font.ITALIC, 15));
		...
		agregarPanel.setBackground(new Color(104, 104, 104));
		
		actualizarPanel = new JPanel();
		actualizarPanel.setLayout(null);
		actualizarPanel.setBounds(400, 5, 370, 410);
		actualizarPanel.setBackground(new Color(104, 104, 104));
		...
		t_agregar.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		agregarConfirmar.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		t_actualizar.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarNombre.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		campoE_n.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarMarca.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		campoE_m.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarPrecio.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		campoE_p.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarDist.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		campoE_d.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarCantidad.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		campoE_c.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		actualizarConfirmar.setFont(new Font("Bahnschrift", Font.BOLD, 15));
		...
		scrolllist_panel_nombres.setBackground(Color.LIGHT_GRAY);
		...
		background.setBounds(0,0, 800, 460);
		
		image = new JLabel(new ImageIcon("src/Assets/bg.png"));
		image.setBounds(0,0,800, 460);
		...
		this.eliminarPanel.setVisible(false);
		
		
		
		
		add(agregar, JLayeredPane.PALETTE_LAYER);
		add(listar, JLayeredPane.PALETTE_LAYER);
	...
	public void adicionarContenido(String nombre, String marca, double precio, String dist, int cant) {
		...
		temp_panel.setBackground(new Color(104, 104, 104));
