...
public class MyLinkedList<E> {
	...
	//Elimina el primer nodo, lo que obliga a todos los demas nodos a moverse hacia atras
	public E extract() {
		E data = null;
		if(this.first != null) {
	...
	//Elimina x nodo, lo que obliga a juntar los dos nodos separados por el que se extrajo
