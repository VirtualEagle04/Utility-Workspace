...
/**
 * Comprende la lógica entre la interfaz de usuario y los objetos
...
public class Controlador implements ActionListener {
	...
	/**
	 * Define cada boton de la interfaz gráfica, con su respectiva función.
	 * 
	 */
	...
	/**
	 * 
	 * Define las interacciones de actualización y eliminación presentes en los objetos 
	 * creados, los cuales contienen la información respectiva frente al material registrado.
	 * 
	 */
		...
		switch(e.getActionCommand()) {
			...
			case "agregar_confirmar": {
				...
				if(menu.getCampo_n().getText().isEmpty()) {
					menu.getCampo_n().setText("Nombre invalido");
				}
				else {
				...
				if(menu.getCampo_m().getText().isEmpty()) {
					menu.getCampo_m().setText("Marca invalida");
				}
				else {
				...
				try {
					 ...
					 menu.getCampo_p().setText("Caracteres invalidos");
				 }
				
				if(menu.getCampo_d().getText().isEmpty()) {
					menu.getCampo_d().setText("Distribuidor invalido");
				}
				else {
				...
				try {
					 ...
					 menu.getCampo_c().setText("Caracteres invalidos");
				 }
